      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Gmail Sync</h1>
            <p className="text-gray-500 mt-2">
              Internal email sync and automation platform
            </p>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center mt-6">
            By connecting, you grant this app access to read your Gmail inbox
            for sync purposes. Your data stays within our internal systems.
          </p>
        </div>
      </div>
    </div>
