          ...
          <div className="bg-gradient-to-r from-pink-500 to-purple-600 px-8 pt-10 pb-8 text-center relative">
            ...
            <div className="mt-6">
              <button
                ...
                className="cursor-pointer inline-flex items-center justify-center gap-3 px-8 py-3 bg-white rounded-xl text-gray-700 font-semibold shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all duration-200"
              >
